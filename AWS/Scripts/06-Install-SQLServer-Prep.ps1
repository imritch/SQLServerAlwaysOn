...
Write-Host "`n[3/3] Creating SQL Server directories..." -ForegroundColor Yellow
...
Write-Host "`nNow run SQL Server Setup manually with these settings:" -ForegroundColor Yellow
...
Write-Host "`nAfter installation, run: 07-Enable-AlwaysOn.ps1" -ForegroundColor Yellow
